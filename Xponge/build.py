...
def save_pdb(cls, filename=None, write_cryst1=True):
    """
    This **function** saves the iput object as a pdb file

    :param cls: the object to save
    :param filename: the name of the output file
    :param write_cryst1: whether to write the CRYST1 line
    :return: None
    """
    if isinstance(cls, AbstractMolecule):
        ...
        if write_cryst1 and cls.box_length is not None:
            if hasattr(cls, "box_angle") and cls.box_angle is not None:
                alpha, beta, gamma = cls.box_angle
            else:
                alpha, beta, gamma = 90.0, 90.0, 90.0
            towrite += "CRYST1{0:9.3f}{1:9.3f}{2:9.3f}{3:7.2f}{4:7.2f}{5:7.2f} P 1           1\n".format(
                cls.box_length[0], cls.box_length[1], cls.box_length[2], alpha, beta, gamma)
