...
-mdout protein/mdout.txt -box protein/run.box -frc protein/force.dat > protein/rerun.log") == 0
    ...
    _check_one_energy(gmx_mdout["LJ (SR)"] + gmx_mdout["Disper. corr."], "protein_plot/LJ", t.LJ_short + t.LJ_long)
...
-box dna/run.box -frc dna/force.dat > dna/rerun.log") == 0
...
-mdout rna/mdout.txt -box rna/run.box -frc rna/force.dat > rna/rerun.log") == 0
    ...
    _check_one_energy(gmx_mdout["LJ (SR)"] + gmx_mdout["Disper. corr."], "rna_plot/LJ", t.LJ_short + t.LJ_long)
